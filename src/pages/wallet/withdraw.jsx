...
import TabOne from "../../components/pages/wallet/withdraw/TabOne";
import TabTwo from "../../components/pages/wallet/withdraw/TabTwo";
  ...
  return (
    <div className="bg-common-bg h-full flex flex-col">
      ...
      <div className="grow h-full overflow-y-auto">
        <Tabs defaultTab={0}>
          <TabsButtons className="flex items-center text-xs pt-3 justify-start bg-light-bg cursor-pointer overflow-hidden">
            {tabs.map((tab, i) => (
              <TabButton
