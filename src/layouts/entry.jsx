...
const EntryLayout = () => {
  return (
    <div
      className="h-screen bg-center bg-cover relative flex flex-col overflow-x-hidden overflow-y-auto"
      style={{ backgroundImage: `url(${login_bg})` }}
    >
      <div className="absolute inset-0 z-0 bg-black bg-opacity-20"></div>
      <div className="relative z-10">
        <div className="py-6 px-3 flex flex-col justify-center space-y-4">
      ...
      <div className="flex items-center justify-center space-x-2 relative z-10 text-white py-14">
